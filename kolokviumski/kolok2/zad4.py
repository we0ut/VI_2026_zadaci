...
if __name__ == "__main__":
    ...
    dataset_new = [row[:col_index] + row[col_index+1:]for row in dataset]

    X, y = [row[:-1] for row in dataset_new], [row[-1] for row in dataset_new]
    split = int(0.85 * len(dataset_new))
    ...
    probas = model.predict_proba([new_sample])[0]
    print(probas)
