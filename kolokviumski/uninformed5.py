...
class PacMan(Problem):
    def __init__(self, initial, grid, walls):
    ...
    def successor(self, state):
        ...
        pacman, postaven, kords = state
        px,py = pacman
        orientacija = postaven
        dots = kords
        # eaten = n
        ...
        for action, ((dx,dy), n_orientacija) in moves[orientacija].items():
            npx, npy = px+dx, py+dy

            if self.check_valid((npx,npy)):
                ndots = [d for d in dots if d != (npx,npy)]

                succ[action] = ((npx,npy), n_orientacija, tuple(ndots))
    ...
    def check_valid(self, man):
        ...
        return 0<=px<self.grid[0] and 0<=py<self.grid[1] and (px,py) not in self.walls
...
if __name__ == "__main__":
    ...
    for _ in range(n):
        kord = input()
        x1,y1 = kord.split(",")
        kords.append((int(x1),int(y1)))

    kords = tuple(kords)



    initial = ((x,y), postaven, kords)
    grid = (10,10)
    walls = ((0,6), (0,8), (0,9), (1,2), (1,3), (1,4), (1,9), (2,9), (3,6), (3,9), (4,1), (4,5), (4,6), (4,7), (5,1), (5,6), (6,0), (6,1), (6,2), (6,9), (8,1), (8,4), (8,7), (8,8), (9,4), (9,7), (9,8))
    pacman = PacMan(initial, grid, walls)
